...
chest and shows only a cuff, forearm and hand. Colours (White Female): blouse fill about (170-180, 180-195, 210-220,
i.e. blue is the highest channel), skin about (250, 170, 120), everything else dark. `cream` is kept as the variable
name throughout this ported module (it means "the sleeve's own fill colour", whatever that colour is for this
character) so the rest of the file, which refers to it by that name, needed no other changes.
"""
import numpy as np
...
def colour_masks(c):
    ...
    cream = a & (b > r + 15) & (b > 150) & (g < b) & (r > 80) & (r < 225) & ~skin
    return a, skin, cream
