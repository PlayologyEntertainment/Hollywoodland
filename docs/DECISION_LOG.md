...
| Six player characters | Owner review of the redesigned Character Creator: a six-character selector (White, Asian and Black man and woman) replaces customisation, on the creator background image, with the full-size character in the centre. Designs, headshots and portraits are in; the walk cycles for the five new characters are phase 2 (all six currently walk as the White Male). Built on `claude/character-select`, not committed (`art/prompts/character-player-roster.md`) | 2026-09-20 |
