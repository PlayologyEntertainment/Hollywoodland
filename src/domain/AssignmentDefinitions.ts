...
export const SCENE_STUDY_CLASS: AssignmentDefinition = {
  ...
  description: 'A church-basement acting class, three nights a week — worth 15 XP.',
...
export const DINER_COUNTER_SHIFT: AssignmentDefinition = {
  ...
  description: 'Pour coffee and bus tables for a few hours of grocery money — $25 and 5 XP.',
  requiredHousingTier: 'room',
  durationMinutes: 15,
...
export const RUN_LINES_WITH_SCENE_PARTNER: AssignmentDefinition = {
  ...
  description: `Spend the evening running lines with ${SCENE_PARTNER.role.toLowerCase()} — 5 trust and 2 XP.`,
  requiredHousingTier: 'room',
  durationMinutes: 5,
  rewards: [
...
export const EARLY_NIGHT_IN: AssignmentDefinition = {
  ...
  description: 'Skip the noise, sleep it off, and start tomorrow rested — 40 energy and 25 XP.',
  requiredHousingTier: 'room',
  durationMinutes: 120,
  rewards: [{ kind: 'resource-delta', delta: { energy: 40 } }, { kind: 'xp-grant', amount: 25 }],
};
...
export const ADVANCED_SCENE_WORKSHOP: AssignmentDefinition = {
  ...
  description: 'A full-day intensive, worth having your own walls for — 40 XP.',
